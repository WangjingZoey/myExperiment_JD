...
public class PorterStemmer{
    ...
    public static char[] b; /* 用来存待词干提取的单词（以char的形式） */
    public static int i,     /* b中的元素位置（偏移量） */
            i_end, /* 要抽取词干单词的结束位置 */
            j, k;
    public static final int INC = 50;/* 随着b的大小增加数组要增长的长度（防止溢出） */
     ...
     * 返回单词的词干。
     */
    public static String toStrings() { return new String(b,0,i_end); }
     ...
     */
    public static final boolean cons(int i){  
        switch (b[i]){  
    ...
    */
     ...
     */
    public static final boolean vowelinstem(){  
        int i; 
        for (i = 0; i <= j; i++) 
            if (!cons(i)) 
                return true;
     ...
     */
    public static final boolean doublec(int j){  
        if (j < 1) return false;
     ...
     * @return boolean
     */
    public static final boolean cvc(int i){  
     ...
     * @return 判断b是否以s结尾
     */
    public static final boolean ends(String s){  
        int l = s.length();
        int o = k-l+1;
        if (o < 0) return false;
        for (int i = 0; i < l; i++) 
     ...
     * @param s 字符串
     */
    public static final void setto(String s){  
        int l = s.length();
        int o = j+1;
        for (int i = 0; i < l; i++) 
            b[o+i] = s.charAt(i);
     ...
     * @param s 字符串
     */
    public static final void r(String s) { 
        if (m() > 0) setto(s); 
    }
    ...
    */
    ...
    private static final void step2() { 
     ...
     * 注意在去除后缀之前必须确保m()>0.
     */
    private final static void step3() { 
        if (k == 0) return;  
        switch (b[k-1]){
    ...
    private final static void step4() { 
        switch (b[k]){
    ...
    public static final void step5(){   
    ...
    * Usage: Stemmer file-name file-name ...
    ...
    public static void main(String[] args){
      ...
      System.out.println(stem("happiness"));
